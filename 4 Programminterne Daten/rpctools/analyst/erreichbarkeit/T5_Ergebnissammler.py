    ...
    def run(self):
    	...
    	if Nutzungstyp==0:
    		...
    		if Nutzungstyp==3:
    			if erstelle_DichtesteEntfernung()==0:
    				...
    				resultpath = join(base_path,"3 Benutzerdefinierte Projekte",projektname,"FGDB_34_Standortkonkurrenz_Supermaerkte_"+projektname+".gdb")
    	...
    	##    messages.AddMessage(Nutzungstyp)
    		if Nutzungstyp==3 and arcpy.Exists(join(workspace_projekt_ergebnisse, "37_Distanz_veraenderung.jpg")):
    			...
    			# Pfade zu Grafiken herstellen
    			image1 = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen', "37_Distanz_veraenderung.jpg")
    			###Grafiken einf??gen
    		...
    		image = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen', "37_Karte_Haltestellen.jpg")
    		...
    		for n in name:
    			...
    			barcode = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen', n+".png")
    	...
    	#kann nur noch Nettowohnen sein
    		...
    		Haltestellen_mxd = arcpy.mapping.MapDocument(mxdpfad)
    		templatepath = join(base_path,"2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","template.gdb")
    		resultpath = join(base_path,"3 Benutzerdefinierte Projekte",projektname,"FGDB_37_Erreichbarkeit_"+projektname+".gdb")
    		Haltestellen_mxd.findAndReplaceWorkspacePaths(templatepath, resultpath)
    		...
    		barcode = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen','37_Erreichbarkeit_zuFuss.jpg')
    		if os.path.isfile(barcode):
    		...
    		barcode = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen','37_Erreichbarkeit_Fahrrad.jpg')
    		if os.path.isfile(barcode):
    		...
    		barcode = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen','37_Erreichbarkeit_Pkw.jpg')
    		if os.path.isfile(barcode):
