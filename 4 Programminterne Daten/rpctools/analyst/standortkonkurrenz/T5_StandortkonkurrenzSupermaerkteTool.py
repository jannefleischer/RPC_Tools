...
class Standortkonkurrenz(Tool):
    ...
    def run(self):
    	...
    	mxd_template = arcpy.mapping.MapDocument(join(base_path, "2_Tool","Standortkonkurrenz_Supermaerkte","Template_Kartenerzeugung","34_KK_Bindung_Template.mxd"))
    	...
    	templatepath = join(base_path,"2_Tool","Standortkonkurrenz_Supermaerkte","Template_Kartenerzeugung","template.gdb")
    	resultpath = join(base_path,"3 Benutzerdefinierte Projekte",projektname,"FGDB_Standortkonkurrenz_Supermaerkte_"+projektname+".gdb")
    	...
    	image = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen', "34_Bestandregion.jpg")
    	...
    	image = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen', "34_KK_Bindung.jpg")
    	...
    	tablepath_neuer_markt = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'FGDB_34_Standortkonkurrenz_Supermaerkte.gdb','Neuer_Markt')
    	tablepath_siedlungszellen = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'FGDB_34_Standortkonkurrenz_Supermaerkte.gdb','Siedlungszahlendaten')
    	tablepath_standorte = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'FGDB_34_Standortkonkurrenz_Supermaerkte.gdb','Standortdaten')
    	tablepath_neuerMarkt = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'FGDB_34_Standortkonkurrenz_Supermaerkte.gdb','Neuer_Markt')
    	tablepath_zentren = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'FGDB_34_Standortkonkurrenz_Supermaerkte.gdb','Zentren')
    	tablepath_matrix = join(base_path,'3 Benutzerdefinierte Projekte',projektname,'FGDB_34_Standortkonkurrenz_Supermaerkte.gdb','Distanzmatrix_planfall')
