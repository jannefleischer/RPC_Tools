...
class TbxVerkehrsmengenErmitteln(Tbx):
    ...
    @property
    def label(self):
        return encode(u'Verkehrsmengen ermitteln')
    ...
    def _getParameterInfo(self):
        ...
        heading = u"02 - Parameter f�r Einzelhandel".encode('CP1252')
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        ...
        heading = u"03 - Parameter f�r Gewerbebetriebe".encode('CP1252')
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        ...
        heading = u"04 - Parameter f�r Schulen".encode('CP1252')
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        i+=1 ; self.params[i].category = heading
        ...
        param_7.displayName = u'Bruttogeschossfl�che je besch�ftigter Person (m�)'.encode('CP1252')
        ...
        param_8.displayName = u'Anwesenheit besch�ftigter Personen'.encode('CP1252')
        ...
        param_9.displayName = u'Wege je besch�ftigter Person und Werktag'.encode('CP1252')
        ...
        param_12.displayName = u'Kunden je Bruttogeschossfl�che und Werktag'.encode('CP1252')
        ...
        param_13.displayName = u'Lieferwege je 100m� Bruttogeschossfl�che'.encode('CP1252')
        ...
        param_14.displayName = u'Anwesenheit besch�ftigter Personen'.encode('CP1252')
        ...
        param_15.displayName = u'Wege je besch�ftigter Person und Werkag'.encode('CP1252')
        ...
        param_18.displayName = u'Wege der Kunden je Besch�ftigtem'.encode('CP1252')
        ...
        param_19.displayName = u'Lieferwege je Besch�ftigtem'.encode('CP1252')
        ...
        param_20.displayName = u'Wege je Sch�ler'.encode('CP1252')
        ...
        param_22.displayName = u'Sch�ler je KFZ'.encode('CP1252')
        ...
        param_23.displayName = u'Sch�ler je Lehrkraft'.encode('CP1252')
        ...
        param_26.displayName = u'Lieferwege je Sch�ler'.encode('CP1252')
