...
class TbxInfrastrukturkostenermittlung(Tbx):
    ...
    @property
    def label(self):
        return encode(u'Infrastrukturkosten ermitteln')
    ...
    def _getParameterInfo(self):
        ...
        param_17.datatype = language('string')
        ...
        param_19.datatype = language('string')
        ...
        param_20.datatype = language('string')
        ...
        param_21.datatype = language('string')
        ...
        param_22.datatype = language('string')
        ...
        param_23.datatype = language('string')
        ...
        param_24.datatype = language('string')
        ...
        param_25.datatype = language('string')
        ...
        param_26.datatype = language('string')
