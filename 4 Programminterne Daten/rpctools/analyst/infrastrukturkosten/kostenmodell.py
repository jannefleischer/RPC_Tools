...
class Kostenmodell(Tool):
    ...
    def run(self):
        ...
        sonderkostenfaktor = self.par.sonderkostenfaktor.value
        entwaesserungssystem = self.par.entwaesserungssystem.value
        ### 01 - Zusatzangaben Entwässerung ###
        rueckhaltebecken_typ = self.par.rueckhaltebecken_typ.value
        rueckhaltebecken_m3 = self.par.rueckhaltebecken_m3.value
        zus_kanalmeter = self.par.zus_kanalmeter.value
        ### 02 - Zusätzliche Kostenfaktoren ###
        zus_herstellungskosten = self.par.zus_herstellungskosten.value
        zus_betriebskosten = self.par.zus_betriebskosten.value
        ### 03 - Aufteilung der Kosten auf Kostenträger ###
        KB1_KP1 = self.par.KB1_KP1.value
        KB2_KP1 = self.par.KB2_KP1.value
        KB2_KP2 = self.par.KB2_KP2.value
        KB2_KP3 = self.par.KB2_KP3.value
        KB3_KP1 = self.par.KB3_KP1.value
        KB3_KP2 = self.par.KB3_KP2.value
        KB3_KP3 = self.par.KB3_KP3.value
        KB4_KP1 = self.par.KB4_KP1.value
        KB4_KP2 = self.par.KB4_KP2.value
        KB4_KP3 = self.par.KB4_KP3.value
        KB5_KP1 = self.par.KB5_KP1.value
        KB5_KP2 = self.par.KB5_KP2.value
        KB5_KP3 = self.par.KB5_KP3.value
        KB6_KP1 = self.par.KB6_KP1.value
        KB6_KP2 = self.par.KB6_KP2.value
        KB6_KP3 = self.par.KB6_KP3.value
        KB7_KP1 = self.par.KB7_KP1.value
        KB7_KP2 = self.par.KB7_KP2.value
        ...
        ausgabeordner = join(projectpath,'Ergebnisausgabe','Excel')
        ...
        intern_path = self.folders.INTERN
        text_path = join(intern_path,"rpctools","analyst","infrastrukturkosten","Erlaeuterungstexte")
        methodik_grafik = join(text_path, "Methodik_KommunaleInfrastrukturkosten.png")
        #methodik_grafik = join(base_path,"2_Tool","Infrastrukturkosten","Erlaeuterungstexte","Methodik_KommunaleInfrastrukturkosten.png")
        ...
        text_path = join(intern_path,"rpctools","analyst","infrastrukturkosten","Erlaeuterungstexte")
        haftung_grafik = join(text_path, "Haftungsausschluss.png")
        #haftung_grafik = join(base_path,"2_Tool","Infrastrukturkosten","Erlaeuterungstexte","Haftungsausschluss.png")
