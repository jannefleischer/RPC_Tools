...
class OekologischeFolgen(Tool):
    ...
    def run(self):
		...
		projektName = parameters[i].valueAsText
		i=i+1
		region = parameters[i].valueAsText
		...
		messages.AddMessage(bedeckungNullfall)
		...
		messages.AddMessage(bedeckungPlanfall)
		...
		i=i+1
		gemeinsameGrenze = 0
		gemeinsameGrenze = parameters[i].valueAsText
		i=i+1
		gesamteGrenze = 0
		gesamteGrenze = parameters[i].valueAsText
		#i=i+1
		#neuinanspruchnameHA = 2.3
		#neuinanspruchnameHA = parameters[i].valueAsText
		#neuinanspruchnameHA = neuinanspruchnameHA.replace(",",".")
		#i=i+1
		#bebauungsdichteWEproHA = 25
		#bebauungsdichteWEproHA = parameters[i].valueAsText
		#i=i+1
		#frueherBauluecke = "False"
		#frueherBauluecke = parameters[i].valueAsText
		i=i+1
		flaechentyp = "Wohnen"
		flaechentyp = parameters[i].valueAsText
		i=i+1
		schutzBoden = parameters[i].valueAsText
		...
		try:
			...
			# messages.AddMessage("bewertungUZVRNullfall: "+str(bewertungUZVRNullfall) + "\n")
			# print("begegnungswahrscheinlichkeitUZVRNullfall: "+str(begegnungswahrscheinlichkeitUZVRNullfall) + "\n")
			# messages.AddMessage("begegnungswahrscheinlichkeitUZVRNullfall: "+str(begegnungswahrscheinlichkeitUZVRNullfall) + "\n")
			# print("begegnungswahrscheinlichkeitUZVRPlanfall: "+str(begegnungswahrscheinlichkeitUZVRPlanfall) + "\n")
			# messages.AddMessage("begegnungswahrscheinlichkeitUZVRPlanfall: "+str(begegnungswahrscheinlichkeitUZVRPlanfall) + "\n")
			# print("groessterUZVR: "+str(groessterUZVR) + "\n")
			# messages.AddMessage("groessterUZVR: "+str(groessterUZVR) + "\n")
			...
			messages.AddMessage("Schutzwuerdige Boeden betroffen:" + schutzBoden)
		...
		##    ergebnisZeile.statusBiotope = schutzstatusBiotope --> aufgrund fehlerhafter Abfrage wird dieser Schritt in der Ergebnisausgabe abgefragt
			...
			messages.AddMessage("Schutzwürdige Böden betroffen? = " + str(schutzBoden))
			print("Ergebnisse gespeichert")
			messages.AddMessage("Ergebnisse gespeichert")
			del ergebnisCursor
