...
class BewertungWohnflaechendichte(Tool):
    ...
    def run(self):
        ...
        workspace_ergebnisse = join(rootPfad,'3 Benutzerdefinierte Projekte',projektname,'FGDB_Flaeche_und_Oekologie.gdb')
        #workspace_ergebnisse = rootPfad +'\\3 Benutzerdefinierte Projekte\\'+projektname+'\\FGDB_36_Flaeche_und_Oekologie.gdb\\'
        ...
        fc = rootPfad + "\\2_Tool\\Flaeche_und_Oekologie\\FGDB_Flaeche_und_Oekologie_Tool.gdb\\GrundlagenDE"
    ...
    #Durschnittswerte der einzelnen Kreistypen in einer in_memory Tabelle ablegen
        ...
        table2 = rootPfad+"\\2_Tool\\Flaeche_und_Oekologie\\FGDB_Flaeche_und_Oekologie_Tool.gdb\\RaumTypen"
        sql = ("ID = " + str(kreistyp))
        ...
        output = rootPfad + "\\3 Benutzerdefinierte Projekte\\"+projektname + "\\Ergebnisausgabe\\Abbildungen\\Bewertung_Wohnflaeachendichte.png"
