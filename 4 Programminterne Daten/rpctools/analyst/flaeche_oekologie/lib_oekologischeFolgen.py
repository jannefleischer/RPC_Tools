...
##        ergebnisTabelle = rootPfad + "\\3 Benutzerdefinierte Projekte\\" + projektName + "\\FGDB_36_Flaeche_und_Oekologie_" + projektName + ".gdb\\Ergebnisse_oekologischeWertigkeit"
...
##        ergebnisZeile = ergebnisCursor.newRow()
        ...
        flaechenPlangebiet = join(rootPfad,"3 Benutzerdefinierte Projekte",projektName,"FGDB_Definition_Projekt_"+projektName+ ".gdb","Teilflaechen_Plangebiet")
        ...
        arcpy.env.workspace = join(rootPfad,"2_Tool","Flaeche_und_Oekologie","FGDB_Flaeche_und_Oekologie_Tool.gdb","NRW")
...
def uzvr(projektName, Region):
    ...
    try:
        ...
        #arcpy.AddMessage(wcd)
        #Pfad zur Ergebnistabelle
        projektOrdner = join(wcd,"3 Benutzerdefinierte Projekte",projektName,"FGDB_Flaeche_und_Oekologie_" + projektName +".gdb")
       ...
       # arcpy.AddMessage(ergebnisTabelle)
        ...
        projektFlaeche = join(wcd,"3 Benutzerdefinierte Projekte",projektName,"FGDB_Definition_Projekt_" + projektName+".gdb","Teilflaechen_Plangebiet")
        ...
        # uzvr = join(wcd,"3 Benutzerdefinierte Projekte",projektName,"FGDB_36_Flaeche_und_Oekologie_" + projektName +".gdb","uzvr_de")
        # auskommentiert, da die uzvr jetzt zentral vorgehalten werden

        uzvr = join(wcd,"2_Tool","Flaeche_und_Oekologie","FGDB_Flaeche_und_Oekologie_Tool.gdb","uzvr_de")
