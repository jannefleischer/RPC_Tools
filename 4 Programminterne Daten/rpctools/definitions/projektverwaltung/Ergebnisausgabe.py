...
def main(projektname):
    ...
    minimap = join(join(base_path,'3 Benutzerdefinierte Projekte',projektname,'Ergebnisausgabe','Abbildungen', '11_Minimap.jpg'))
