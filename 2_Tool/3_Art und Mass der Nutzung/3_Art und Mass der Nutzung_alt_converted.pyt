...
class Flaechenbilanz(object):
    ...
    def execute(self, parameters, messages):
        with script_run_as(u'C:\\GGR\\RPC_Tools\\2_Tool\\3_Art und Mass der Nutzung\\flaechenbilanz.py'):
            # -*- coding: utf-8 -*-
            # ---------------------------------------------------------------------------
            # REGIOPROJEKTCHECK
            # 10_Kostenmodell.py
...
class Nutzungen(object):
    ...
    def updateMessages(self, parameters):
        ...
        if validator:
             return validator(parameters).updateMessages()
    def execute(self, parameters, messages):
        with script_run_as(u'C:\\GGR\\RPC_Tools\\2_Tool\\3_Art und Mass der Nutzung\\nutzungen.py'):
            # -*- coding: utf-8 -*-
