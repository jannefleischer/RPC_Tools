...
##        ergebnisZeile = ergebnisCursor.newRow()
        ...
        flaechenPlangebiet = os.path.join(rootPfad,"3_Projekte",projektName,"FGDB_11_Definition_Projekt_"+projektName+ ".gdb","Teilflaechen_Plangebiet")
        ...
        arcpy.env.workspace = os.path.join(rootPfad,"2_Tool","36_Flaeche_und_Oekologie","FGDB_36_Flaeche_und_Oekologie_Tool.gdb","NRW")
...
def uzvr(projektName, Region):
    ...
    try:
        ...
        #arcpy.AddMessage(wcd)
        #Pfad zur Ergebnistabelle
        projektOrdner = os.path.join(wcd,"3_Projekte",projektName,"FGDB_36_Flaeche_und_Oekologie_Projekt_" + projektName +".gdb")
       ...
       # arcpy.AddMessage(ergebnisTabelle)
        ...
        projektFlaeche = os.path.join(wcd,"3_Projekte",projektName,"FGDB_11_Definition_Projekt_" + projektName+".gdb","Teilflaechen_Plangebiet")
        ...
        uzvr = os.path.join(wcd,"2_Tool","36_Flaeche_und_Oekologie","FGDB_36_Flaeche_und_Oekologie_Tool.gdb","uzvr_de")
