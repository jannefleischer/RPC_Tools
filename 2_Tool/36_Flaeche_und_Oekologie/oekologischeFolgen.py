...
#
# Created:     07.05.2013
# Copyright:   (c) rieffel/mayr 2013
# Licence:     <your licence>
#
# letzte Überarbeitung: 22.07.2014, Alex Mayr
#-------------------------------------------------------------------------------
...
if flaechentyp == "Wohnen":
    ...
    'values': "='Uebersicht Einord. in Region'!$B$18:$B$20",
    'categories': "='Uebersicht Einord. in Region'!$A$18:$A$20",
    })
...
'values': "='Uebersicht lokale Effekte'!$B$5:$C$5",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Ueberbaute Flaechen',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$6:$C$6",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Natuerliche Wasserflaeche',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$7:$C$7",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Platten',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$8:$C$8",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Baeume, Straeucher',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$9:$C$9",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Wassergebundene Decke, Rasengittersteine',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$10:$C$10",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Stauden',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$11:$C$11",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Wiese',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$12:$C$12",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Asphalt, Beton',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$13:$C$13",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Offener Boden, Acker',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$14:$C$14",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Kleinpflaster',
})
chart_Bodenbedeckung.add_series({
'values': "='Uebersicht lokale Effekte'!$B$15:$C$15",
'categories': "='Uebersicht lokale Effekte'!$B$4:$C$4",
'name': 'Rasen',
})
