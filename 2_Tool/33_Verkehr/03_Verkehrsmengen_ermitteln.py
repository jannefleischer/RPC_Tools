...
import arcpy, os, inspect, pyodbc, shutil, gc, sys, urllib, imp
...
##Wohnen_Wege_EW = 3.3
##Wohnen_MIV_Anteil = 0.65
##Wohnen_Pers_KFZ = 1.1
##Wohnen_Anteil_Besucherfahrten = 0.15
##Wohnen_WF_Fahrten_je_EW = 0.05
...
##Versorgung_BGF_Beschaeftigter = 55
##Versorgung_Anwesenheit = 0.9
##Versorgung_Wege_Beschaeftigter = 2.5
##Versorgung_MIV_Anteil = 0.65
##Versorgung_Pers_KFZ = 1.1
##Versorgung_Besucher_Tag = 2.25
##Versorgung_Lieferwege_100m2 = 0.3
...
##Gewerbe_Anwesenheit = 0.9
##Gewerbe_Wege_Beschaeftigter = 2.0
##Gewerbe_MIV_Anteil = 0.65
##Gewerbe_Pers_KFZ = 1.1
##Gewerbe_Anteil_Besucherfahrten = 0.05
##Gewerbe_Lieferwege_Beschaeftigte = 0.05
...
##Schulen_Wege_Schueler = 2
##Schulen_MIV_Anteil = 0.65
##Schulen_Schueler_KFZ = 1.5
##Schulen_Schueler_je_Lehrer = 10
##Schulen_Wege_Lehrer = 2
##Schulen_Pers_KFZ = 1.1
##Schulen_Lieferwege_Schueler = 0.01
...
projekt_bevoelkerungszahl = os.path.join(workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt')
...
#berechne maximale Personenzahl je Teilflaeche - Schritt 1
eingangstabellen = [
    (workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt')
]

ausgabetabelle = (workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt_temp')

sql = """SELECT T03ERG_Bevoelkerung_Projekt.Teilflaeche_Plangebiet, T03ERG_Bevoelkerung_Projekt.Jahr, Sum(T03ERG_Bevoelkerung_Projekt.Bewohner) AS SummevonBewohner INTO T03ERG_Bevoelkerung_Projekt_temp
...
#berechne maximale Personenzahl je Teilflaeche - Schritt 2
eingangstabellen = [
    (workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt_temp')
]

ausgabetabelle = (workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt_Max')

sql = """SELECT T03ERG_Bevoelkerung_Projekt_temp.Teilflaeche_Plangebiet, Max(T03ERG_Bevoelkerung_Projekt_temp.SummevonBewohner) AS EW INTO T03ERG_Bevoelkerung_Projekt_Max
FROM T03ERG_Bevoelkerung_Projekt_temp
GROUP BY T03ERG_Bevoelkerung_Projekt_temp.Teilflaeche_Plangebiet;
"""

mdb.temp_mdb(eingangstabellen,sql,ausgabetabelle)

#loesche zwischentabelle
temp = os.path.join(workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt_temp')
...
bevoelkerung_max_tf = os.path.join(workspace_projekt_bevoelkerung,"T03ERG_Bevoelkerung_Projekt_Max")
...
arcpy.CalculateField_management(grid, "Traffic_Steigerung", "1 - (!Traffic_Planfall! or 0) / (!Traffic_Nullfall! or 0)", "PYTHON", "")
...
#Kopiere Templatemxd
mxd_template = arcpy.mapping.MapDocument(os.path.join(base_path, "2_Tool","33_Verkehr","Style","template_mxd.mxd"))
ausgabeordner = os.path.join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen')
mxdpfad = os.path.join(ausgabeordner,'33_Verkehr.mxd')
...
#Exportiere Ergebnis
arcpy.mapping.ExportToJPEG(verkehr_mxd, os.path.join(ausgabeordner, '33_Verkehr.jpg'), "PAGE_LAYOUT",resolution=300)
...
bevprojektmax = os.path.join(workspace_projekt_bevoelkerung,"T03ERG_Bevoelkerung_Projekt_Max")
bevprojekttemp = (workspace_projekt_bevoelkerung,'T03ERG_Bevoelkerung_Projekt_temp')
gewerbebeschaeftigtetemp = (workspace_projekt_definition,'Gewerbe_Beschaeftigte_temp')

deletelist = [routen_ergebniskacheln_sz_join,routen_ergebniskacheln_tf_join,bevprojektmax,bevprojekttemp,gewerbebeschaeftigtetemp]
