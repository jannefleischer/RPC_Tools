...
workspace_projekt = os.path.join(base_path, '3_Projekte', projektname,'FGDB_34_Wertveraenderungen_' + projektname + '.gdb')
##workspace_projekt=(r"C:\Users\Basti\Dropbox\RPC\00_Entwicklungsumgebung\3_Projekte\LKH_Tostedt\FGDB_34_Wertveraenderungen_LKH_Tostedt.gdb")
cur_checker= arcpy.SearchCursor(workspace_projekt+"/Zentren")
array_checker=[]
gefunden=0
