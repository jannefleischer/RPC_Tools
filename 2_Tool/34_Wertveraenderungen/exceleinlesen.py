...
def georeferenz():
    counter=0
    cur_Standorte_temp=arcpy.UpdateCursor(workspace_projekt+"\Standorte_temp")
...
def projektzieren():
    input_features = workspace_projekt+"\Standorte_temp"
    output_features_class = workspace_projekt+"\Standortdaten"
    ...
    arcpy.AlterAliasName(workspace_projekt+"\Standortdaten", 'Standortdaten')
...
##[a,b,c]=gibmirxy('http://query.yahooapis.com/v1/public/yql?q=select * from geo.placefinder where house="13 - 15" and street="Winsener Landstraße" and city="Winsen (Luhe)"and country="Germany" and postal="21423"&appid=hxByDcDV34HxMu78xKN0b33dXezfkwQskuSVJ9PTUKswLDUaVicYpMWGQScmliWv7IP7SEgQKrlvWC7v1jbcU8gZJU62HTk')
##print a , b,c
del projektname,pfadderExcel,workspace_projekt,base_path
