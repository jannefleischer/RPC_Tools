...
flaechenPlangebiet = os.path.join(rootPfad,"3_Projekte",projekt,"FGDB_Definition_Projekt_" + projekt + ".gdb\Teilflaechen_Plangebiet")
...
ergebnisTabelle = os.path.join(rootPfad,"3_Projekte",projekt,"FGDB_Flaeche_und_Oekologie_Projekt_" + projekt + ".gdb","Ergebnisse_Integrationsgrad")
#ergebnisTabelle = rootPfad + "\\3_Projekte\\" + projekt + "\\FGDB_Flaeche_und_Oekologie_Projekt_" + projekt + ".gdb\\Ergebnisse_Integrationsgrad"
