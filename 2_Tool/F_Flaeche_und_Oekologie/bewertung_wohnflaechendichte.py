...
for row in cursor:
    if row.Gebaeudetyp == "Einfamilienhaus":
        efh += row.Anzahl_WE * float(arcpy.GetParameterAsText(1))
    elif row.Gebaeudetyp == "Zweifamilien- oder Doppelhaus":
        efh += row.Anzahl_WE * float(arcpy.GetParameterAsText(2))
    elif row.Gebaeudetyp == "Reihenhaus":
        efh += row.Anzahl_WE * float(arcpy.GetParameterAsText(3))
    elif row.Gebaeudetyp == "Mehrfamilienhaus":
        efh += row.Anzahl_WE * float(arcpy.GetParameterAsText(4))
