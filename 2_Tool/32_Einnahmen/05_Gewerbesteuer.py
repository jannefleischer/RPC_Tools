...
hebesatzProjektkommune = arcpy.GetParameterAsText(1)
...
excelpfad = os.path.join(ausgabeordner,'32_Einnahmen_Gewerbesteuer.xlsx')
...
methodik_grafik = os.path.join(base_path,"2_Tool","32_Einnahmen","Erlaeuterungstexte","Methodik_05_Gewerbesteuer.png")
...
gc.collect()
print "fertig"
arcpy.AddMessage('05_Gewerbesteuer abgeschlossen')