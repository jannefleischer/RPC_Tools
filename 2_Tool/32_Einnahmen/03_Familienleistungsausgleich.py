...
excelpfad = os.path.join(ausgabeordner,'32_Einnahmen_Familienleistungsausgleich.xlsx')
...
methodik_grafik = os.path.join(base_path,"2_Tool","32_Einnahmen","Erlaeuterungstexte","Methodik_03_Familienleistungsausgleich.png")
