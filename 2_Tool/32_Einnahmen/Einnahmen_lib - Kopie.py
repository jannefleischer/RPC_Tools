...
def gewerbesteuer(projektname,jahr,wirtschaftsabschnitt,aufsiedlungsstand):
    ...
    gewerbesteueraufkommen = gewerbesteuermessbetrag*float(gewerbesteuerHebesatz)
    ...
    gewerbesteuerumlage = gewerbesteueraufkommen/float(gewerbesteuerHebesatz)*float(vervielfaeltiger)
    ...
    abschoepfungsquoteNRW = (float(Kreisumlage)+0.9-0.9*float(Kreisumlage))*(fiktiverHebesatz-float(vervielfaeltiger))/(float(gewerbesteuerHebesatz)*100)+(float(vervielfaeltiger)/(float(gewerbesteuerHebesatz)*100))
    #12: Gewerbesteueraufkommen nach KFA NRW
    gewerbesteueraufkommenNachKFANRW = gewerbesteueraufkommen*(1-abschoepfungsquoteNRW)

    arcpy.AddMessage("Gewerbesteueraufkommen abzüglich Umlage: " + str(gewerbesteueraufkommenMinusUmlage))
    arcpy.AddMessage("Gewerbesteueraufkommen nach KFA NRW: "+str(gewerbesteueraufkommenNachKFANRW))
    arcpy.AddMessage("Abschöpfungsquote NRW: "+str(abschoepfungsquoteNRW))
