...
import arcpy, os, sys, math, random, urllib , re, gc, csv, time
...
def Abfahrt(base_path,projektname,Daten):
    ...
    workspace_projekt_wertveraenderung = os.path.join(base_path,'3_Projekte',projektname,'FGDB_37_Erreichbarkeit_Projekt_'+projektname+'.gdb')
...
##    print len (timeline)
    ...
    fig.savefig(workspace_projekt_ergebnisse+"/"+halte,pad_inches=1,dpi=464,facecolor='w', edgecolor='w', bbox_inches='tight')
