...
class KFA(Tool):
    ...
    def run(self):
        ...
        projektRahmendaten = join(base_path ,"3_Projekte",  projektname ,"FGDB_Definition_Projekt_" + projektname +".gdb","Projektrahmendaten")
        ...
        KRU_01_Kreisumlagesaetze_Wirkraum = join(workspace_projekt_einnahmen,'KRU_01_Kreisumlagesaetze_Wirkraum')
        ...
        KFA_01_Wirkraum = join(workspace_projekt_einnahmen,'KFA_01_Wirkraum')
        ...
        KFA_03_Jahresdaten = join(workspace_projekt_einnahmen,'KFA_03_Jahresdaten')
        KFA_01_Wirkraum = join(workspace_projekt_einnahmen,'KFA_01_Wirkraum')
        ...
        KFA_Bevoelkerung_temp = join(workspace_projekt_einnahmen,'KFA_Bevoelkerung_temp')
        ...
        GRST_Grundsteuereinnahmen = join(workspace_projekt_einnahmen,'GRST_Grundsteuereinnahmen')
        ...
        GWST_06_Bilanz = join(workspace_projekt_einnahmen,'GWST_06_Bilanz')
        ...
        EKST_06_Bilanz = join(workspace_projekt_einnahmen,'EKST_06_Bilanz')
        ...
        FLA_01_Ergebnis = join(workspace_projekt_einnahmen,'FLA_01_Ergebnis')
        ...
        KFA_03_Steuerkraftmesszahl = join(workspace_projekt_einnahmen,'KFA_03_Steuerkraftmesszahl')
        ...
        for row in cursor:
            ...
            KFA_Rahmendaten = join(workspace_tool_einnahmen,'KFA_Rahmendaten')
        ...
        KFA_04_VeredelungsfaktorenGemeinden = join(workspace_projekt_einnahmen,'KFA_04_VeredelungsfaktorenGemeinden')
        arcpy.TruncateTable_management(KFA_04_VeredelungsfaktorenGemeinden)

        KFA_02_Statische_Daten = join(workspace_projekt_einnahmen,'KFA_02_Statische_Daten')
        ...
        for row in cursor:
            ...
            table = join(workspace_tool_einnahmen,'KFA_Veredelungsfaktor')
        ...
        ausgabetabelle = join(workspace_projekt_einnahmen,'KFA_05_Zuweisungen')
        ...
        methodik_grafik = join(base_path,"2_Tool","B_Einnahmen","Erlaeuterungstexte","Methodik_06_KFA.png")
