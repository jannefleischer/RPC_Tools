...
def main(parameters, messages):
    ...
    workspace_texte_erlaeterung = join(base_path,'2_Tool','D_Erreichbarkeit','Erlaeuterungstexte')
    workspace_projekt_ergebnisse = join(base_path,'3_Projekte',projektname, 'Ergebnisausgabe', 'Abbildungen')
    workspace_wertveraenderung = join(base_path,'3_Projekte',projektname,'FGDB_Standortkonkurrenz_Supermaerkte.gdb')
    ...
    def erstelle_DichtesteEntfernung():
        ...
        if  arcpy.Exists(join(workspace_wertveraenderung,"Distanzmatrix"))==False or arcpy.Exists(join(workspace_wertveraenderung,"Distanzmatrix_planfall"))==False or arcpy.Exists(  join(workspace_wertveraenderung,"Siedlungszahlendaten"))==False:
            return -1

        cur_Search_Distanzm=arcpy.SearchCursor(join(workspace_wertveraenderung,"Distanzmatrix"))
        cur_Search_Distanzm_plan=arcpy.SearchCursor(join(workspace_wertveraenderung,"Distanzmatrix_planfall"))
        cur_Siedlungszellen=arcpy.UpdateCursor(join(workspace_wertveraenderung,"Siedlungszahlendaten"))

        try:
            arcpy.DeleteField_management(join(workspace_wertveraenderung,"Siedlungszahlendaten"),"d_Dist")
        except:
    ##        messages.AddMessage("Eroor1")
            pass
        try:
            arcpy.AddField_management(join(workspace_wertveraenderung,"Siedlungszahlendaten"), "d_Dist", "DOUBLE")
        except:
    ##        messages.AddMessage("Eroo2")
            pass


        #nun such fuer alle siedlungszellen die dichteste Distanz zu dem naechst dichten markt

        fieldnames = [f.name for f in arcpy.ListFields(join(workspace_wertveraenderung,"Distanzmatrix"))]
    ...
    ##    print len(vektor_d_dicht_vor)
        ...
        fieldnames_nach = [f.name for f in arcpy.ListFields(join(workspace_wertveraenderung,"Distanzmatrix_planfall"))]
    ...
    def check_planungsflaeche():
        cur_Search=arcpy.SearchCursor(join(workspace_projekt,"Flaechenbilanz"))
        typus=0
        for a in cur_Search:
    ...
    ##messages.AddMessage(   Nutzungstyp)
    ...
    if Nutzungstyp==0:
        ...
        if Nutzungstyp==3:
            if erstelle_DichtesteEntfernung()==0:
                ...
                mxd_template = arcpy.mapping.MapDocument(join(base_path, "2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","37_Distanzen_Template.mxd"))
                mxdpfad = join(workspace_projekt_ergebnisse,'37_Distanzen.mxd')
                mxd_template.saveACopy(mxdpfad)

                # Ersetze Datenquelle
                Haltestellen_mxd = arcpy.mapping.MapDocument(mxdpfad)
                templatepath = join(base_path,"2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","template.gdb")
                resultpath = join(base_path,"3_Projekte",projektname,"FGDB_34_Standortkonkurrenz_Supermaerkte_"+projektname+".gdb")
                ...
                arcpy.SelectLayerByLocation_management(gebietLayer, "WITHIN_A_DISTANCE", join(workspace_wertveraenderung,"Neuer_Markt"), "1 Kilometers", "NEW_SELECTION")
                ...
                #Exportiere Ergebnis
                arcpy.mapping.ExportToJPEG(Haltestellen_mxd, join(workspace_projekt_ergebnisse, "37_Distanz_veraenderung.jpg"), "PAGE_LAYOUT",resolution=300)
                ...
                try:
                    arcpy.Delete_management(join(workspace_projekt_ergebnisse, "37_Distanz_veraenderung.jpg"))
                except:
                    pass
        ...
        #==================================================================================================================================================================================
    ##    messages.AddMessage(Nutzungstyp)
        if Nutzungstyp==3 and arcpy.Exists(join(workspace_projekt_ergebnisse, "37_Distanz_veraenderung.jpg")):
            #Einzelhandel
            ...
            Text1 = join(workspace_texte_erlaeterung, 'Methodik_ErreichbarkeitEinzelhandel.png')
            ###Grafiken einfügen
            ...
            # Pfade zu Grafiken herstellen
            image1 = join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen', "37_Distanz_veraenderung.jpg")
            ###Grafiken einfügen
            ...
            cur_Siedlungszellen=arcpy.SearchCursor(join(workspace_wertveraenderung,"Siedlungszahlendaten"))
        ...
        #==================================================================================================================================================================================
            ...
            # Pfade zu Grafiken herstellen
            Text1 = join(workspace_texte_erlaeterung, 'Methodik_ErreichbarkeitGewerbe.png')
            ###Grafiken einfügen
        ...
        with open(join(workspace_projekt_ergebnisse,"Zentrale_Orte_temp.csv"), 'rb') as f:
            mycsv = csv.reader(f)
            for row in mycsv:
        ...
        # Pfade zu Grafiken herstellen
        Text1 = join(workspace_texte_erlaeterung, 'Methodik_ErreichbarkeitWohnenAnbindungsqualitaet.png')
        ###Grafiken einfügen
        ...
        image = join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen', "37_Karte_Haltestellen.jpg")
        ...
        with open(join(workspace_projekt_ergebnisse,"Haltestellen.csv"), 'rb') as f:
            mycsv = csv.reader(f)
            for row in mycsv:
                name.append(row[0])
                style.append(row[1])
        ...
        for n in name:
            ...
            barcode = join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen', n+".png")
    ...
    ##
    ##    # Pfade zu Grafiken herstellen
    ##    Text1 = join(workspace_texte_erlaeterung, 'Methodik_ErreichbarkeitWohnenLiteratur.png')
    ##    ###Grafiken einfügen
    ...
    #kann nur noch Nettowohnen sein
        ...
        #Kopiere Template.mxd
        mxd_template = arcpy.mapping.MapDocument(join(base_path, "2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","37_Erreichbarkeit_Fahrrad_Template.mxd"))
        mxdpfad = join(workspace_projekt_ergebnisse,'37_Erreichbarkeit_Fahrrad.mxd')
        mxd_template.saveACopy(mxdpfad)

        # Ersetze Datenquelle
        Haltestellen_mxd = arcpy.mapping.MapDocument(mxdpfad)
        templatepath = join(base_path,"2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","template.gdb")
        resultpath = join(base_path,"3_Projekte",projektname,"FGDB_37_Erreichbarkeit_"+projektname+".gdb")
        Haltestellen_mxd.findAndReplaceWorkspacePaths(templatepath, resultpath)
        ...
        #Exportiere Ergebnis
        arcpy.mapping.ExportToJPEG(Haltestellen_mxd, join(workspace_projekt_ergebnisse, "37_Erreichbarkeit_Fahrrad.jpg"), "PAGE_LAYOUT",resolution=150)
        ...
        #==================================================================================================================================================================================
        #Kopiere Template.mxd
        mxd_template = arcpy.mapping.MapDocument(join(base_path, "2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","37_Erreichbarkeit_zuFuss_Template.mxd"))
        mxdpfad = join(workspace_projekt_ergebnisse,'37_Erreichbarkeit_zuFuss.mxd')
        mxd_template.saveACopy(mxdpfad)
        ...
        #Exportiere Ergebnis
        arcpy.mapping.ExportToJPEG(Haltestellen_mxd, join(workspace_projekt_ergebnisse, "37_Erreichbarkeit_zuFuss.jpg"), "PAGE_LAYOUT",resolution=150)
        ...
        #==================================================================================================================================================================================
        #Kopiere Template.mxd
        mxd_template = arcpy.mapping.MapDocument(join(base_path, "2_Tool","37_Erreichbarkeit","37_Template_Kartenerzeugung","37_Erreichbarkeit_Pkw_Template.mxd"))
        mxdpfad = join(workspace_projekt_ergebnisse,'37_Erreichbarkeit_Pkw.mxd')
        mxd_template.saveACopy(mxdpfad)
        ...
        #Exportiere Ergebnis
        arcpy.mapping.ExportToJPEG(Haltestellen_mxd, join(workspace_projekt_ergebnisse, "37_Erreichbarkeit_Pkw.jpg"), "PAGE_LAYOUT",resolution=150)
        ...
        # Pfade zu Grafiken herstellen
        Text1 = join(workspace_texte_erlaeterung, 'Methodik_ErreichbarkeitWohnen.png')
        ###Grafiken einfügen
        ws1.insert_image(0, 0, Text1, {'x_scale': 0.32, 'y_scale': 0.32})
        del Text1
        ...
        # Pfade zu Grafiken herstellen
        Text1 = join(workspace_texte_erlaeterung, 'Methodik_ErreichbarkeitWohnenPkwFahrradZuFuss.png')
        ###Grafiken einfügen
        ...
        barcode = join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen','37_Erreichbarkeit_zuFuss.jpg')
        if os.path.isfile(barcode):
        ...
        barcode = join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen','37_Erreichbarkeit_Fahrrad.jpg')
        if os.path.isfile(barcode):
        ...
        barcode = join(base_path,'3_Projekte',projektname,'Ergebnisausgabe','Abbildungen','37_Erreichbarkeit_Pkw.jpg')
        if os.path.isfile(barcode):
        ...
        # Pfade zu Grafiken herstellen
        Text1 = join(workspace_texte_erlaeterung, 'Methodik_Haftung.jpg')
        ###Grafiken einfügen
        ws16.insert_image(0, 0, Text1, {'x_scale': 0.32, 'y_scale': 0.32})
