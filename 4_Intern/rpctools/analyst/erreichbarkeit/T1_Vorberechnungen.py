...
def main(parameters, messages):
    ...
    mxd_template = arcpy.mapping.MapDocument(join(base_path, "2_Tool","D_Erreichbarkeit","Template_Kartenerzeugung","Haltestellenkarte_Template.mxd"))
    ...
    templatepath = join(base_path,"2_Tool","D_Erreichbarkeit","Template_Kartenerzeugung","template.gdb")
    resultpath = join(base_path,"3_Projekte",projektname,"FGDB_Erreichbarkeit_"+projektname+".gdb")
    Haltestellen_mxd.findAndReplaceWorkspacePaths(templatepath, resultpath)

    templatepath = join(base_path,"3_Projekte", "Template","FGDB_Erreichbarkeit_Template"+".gdb")
    resultpath = join(base_path,"3_Projekte",projektname,"FGDB_Definition_Projekt_"+projektname+".gdb")
    Haltestellen_mxd.findAndReplaceWorkspacePaths(templatepath, resultpath)
